...
exports.MATERIAL_CATALOG = void 0;
exports.normalizeMaterialName = normalizeMaterialName;
exports.findMaterialInCatalog = findMaterialInCatalog;
exports.MATERIAL_CATALOG = [
    // === PAINTING ===
    {
 ...
 */
function findMaterialInCatalog(searchTerm) {
    const normalizedSearch = normalizeMaterialName(searchTerm);
    // Exact match
    const exactMatch = exports.MATERIAL_CATALOG.find(m => m.normalizedName === normalizedSearch);
    if (exactMatch)
        return exactMatch;
    // Partial match (search term contains catalog name or vice versa)
    const partialMatch = exports.MATERIAL_CATALOG.find(m => normalizedSearch.includes(m.normalizedName) ||
